...
VALUES ('Juan', 'Perez', 'Calle 123', '3214587895', 'juan.perez@hotmail.com', '1990-05-15', 'activo');

-- Cliente 2
INSERT INTO Clientes (nombre, apellido, direccion, telefono, correo_electronico, fecha_nacimiento, estado)
VALUES ('María', 'Gomez', 'Calle 456', '3214587896', 'maria.gomez@hotmail.com', '1995-08-20', 'activo');

-- Cliente 3
INSERT INTO Clientes (nombre, apellido, direccion, telefono, correo_electronico, fecha_nacimiento, estado)
VALUES ('Pedro', 'Lopez', 'Calle 789', '3214587897', 'pedro.lopez@hotmail.com', '1989-03-10', 'inactivo');

-- Cliente 4
INSERT INTO Clientes (nombre, apellido, direccion, telefono, correo_electronico, fecha_nacimiento, estado)
VALUES ('Ana', 'Martinez', 'Calle 010', '3214587898', 'ana.martinez@hotmail.com', '1996-11-25', 'inactivo');

-- Cliente 5
INSERT INTO Clientes (nombre, apellido, direccion, telefono, correo_electronico, fecha_nacimiento, estado)
VALUES ('Milena', 'Perez', 'Calle 010', '3214587898', 'Milena.Perez@hotmail.com', '1996-11-25', 'inactivo');

-- Tabla Cuentas_Bancarias
-- Cuenta 1
INSERT INTO Cuentas_Bancarias (cliente_id, numero_cuenta, tipo_cuenta, saldo, fecha_apertura, estado)
VALUES (1, '1234567890', 'corriente', 5000.00, '2023-01-10', 'activa');

-- Cuenta 2
INSERT INTO Cuentas_Bancarias (cliente_id, numero_cuenta, tipo_cuenta, saldo, fecha_apertura, estado)
VALUES (2, '9876543210', 'ahorro', 2500.00, '2022-05-20', 'activa');

-- Cuenta 3
INSERT INTO Cuentas_Bancarias (cliente_id, numero_cuenta, tipo_cuenta, saldo, fecha_apertura, estado)
VALUES (3, '1112223330', 'corriente', 8000.00, '2024-03-15', 'activa');

-- Cuenta 4
INSERT INTO Cuentas_Bancarias (cliente_id, numero_cuenta, tipo_cuenta, saldo, fecha_apertura, estado)
VALUES (4, '4445556660', 'ahorro', 3500.00, '2023-11-01', 'activa');

-- Cuenta 5
INSERT INTO Cuentas_Bancarias (cliente_id, numero_cuenta, tipo_cuenta, saldo, fecha_apertura, estado)
VALUES (4, '4445556661', 'corriente', 3500.00, '2023-11-01', 'activa');


--Tabla Transacciones
-- Transacción 1
INSERT INTO Transacciones (cuenta_id, tipo_transaccion, monto, descripcion)
VALUES (1, 'depósito', 1000.00, 'Depósito inicial');

-- Transacción 2
INSERT INTO Transacciones (cuenta_id, tipo_transaccion, monto, descripcion)
VALUES (2, 'retiro', 500.00, 'Retiro en cajero');

-- Transacción 3
INSERT INTO Transacciones (cuenta_id, tipo_transaccion, monto, descripcion)
VALUES (3, 'transferencia', 2000.00, 'Transferencia a cuenta externa');

-- Transacción 4
INSERT INTO Transacciones (cuenta_id, tipo_transaccion, monto, descripcion)
VALUES (4, 'depósito', 1500.00, 'Depósito de salario');
...
-- Sucursal 2
INSERT INTO Sucursales ( nombre, direccion, telefono)
VALUES ('Sucursal Norte', 'Calle Norte 456', '9876543210');

-- Sucursal 3
INSERT INTO Sucursales (nombre, direccion, telefono)
VALUES ('Sucursal Sur', 'Av. Sur 789', '1112223333');

-- Sucursal 4
INSERT INTO Sucursales (nombre, direccion, telefono)
VALUES ('Sucursal Este', 'Calle Este 010', '4445556666');
...
VALUES ('Carlos', 'Gonzalez', 'Avenida Libertador 123', '+555666777', 'carlos.gonzalez@example.com', '2020-02-15', 'Gerente de Sucursal', 4500.00, 1);

-- Empleado 2
INSERT INTO Empleados (nombre, apellido, direccion, telefono, correo_electronico, fecha_contratacion, posicion, salario, sucursal_id)
VALUES ('Laura', 'Hernandez', 'Calle Principal 456', '+333444555', 'laura.hernandez@example.com', '2019-07-10', 'Cajero', 2500.00, 2);

-- Empleado 3
INSERT INTO Empleados (nombre, apellido, direccion, telefono, correo_electronico, fecha_contratacion, posicion, salario, sucursal_id)
VALUES ('Daniel', 'Rojas', 'Avenida Bolivar 789', '+777888999', 'daniel.rojas@example.com', '2021-01-30', 'Analista de Crédito', 3500.00, 1);

-- Empleado 4
INSERT INTO Empleados (nombre, apellido, direccion, telefono, correo_electronico, fecha_contratacion, posicion, salario, sucursal_id)
VALUES ('Carolina', 'Sanchez', 'Calle Secundaria 010', '+111222333', 'carolina.sanchez@example.com', '2023-03-20', 'Asesor Financiero', 3800.00, 3);

-- Tabla Productos_Financieros
-- Producto Financiero 1 
INSERT INTO Productos_Financieros (nombre_producto, tipo_producto, descripcion, tasa_interes)
VALUES ('Préstamo Personal', 'préstamo', 'Préstamo personal para necesidades diversas', 8.5);

-- Producto Financiero 2 
INSERT INTO Productos_Financieros (nombre_producto, tipo_producto, descripcion, tasa_interes)
VALUES ('Tarjeta de Crédito Platinum', 'tarjeta de crédito', 'Tarjeta de crédito con beneficios premium', 18.0);

-- Producto Financiero 3
INSERT INTO Productos_Financieros (nombre_producto, tipo_producto, descripcion, tasa_interes)
VALUES ('Seguro de Vida Familiar', 'seguro', 'Seguro de vida que protege a la familia', 4.2);

-- Producto Financiero 4 
INSERT INTO Productos_Financieros (nombre_producto, tipo_producto, descripcion, tasa_interes)
VALUES ('Préstamo Hipotecario Variable', 'préstamo', 'Préstamo hipotecario con tasa de interés variable', 7.8);
...
VALUES (3, 15000.00, 7.5, '2023-11-20', '2024-11-20', 'activo');

-- Préstamo 3
INSERT INTO Prestamos (cuenta_id, monto, tasa_interes, fecha_inicio, fecha_fin, estado)
VALUES (2, 10000.00, 8.5, '2024-03-10', '2025-03-10', 'activo');

-- Préstamo 4
INSERT INTO Prestamos (cuenta_id, monto, tasa_interes, fecha_inicio, fecha_fin, estado)
VALUES (4, 30000.00, 7.0, '2023-09-01', '2024-09-01', 'activo');
...
VALUES (2, '1234567890123456', 5000.00, 2500.00, '2024-01-01', '2025-01-01', 'activa');

-- Tarjeta de Crédito 2
INSERT INTO Tarjetas_Credito (cuenta_id, numero_tarjeta, limite_credito, saldo_actual, fecha_emision, fecha_vencimiento, estado)
VALUES (4, '9876543210987654', 10000.00, 7500.00, '2023-05-15', '2024-05-15', 'activa');

-- Tarjeta de Crédito 3
INSERT INTO Tarjetas_Credito (cuenta_id, numero_tarjeta, limite_credito, saldo_actual, fecha_emision, fecha_vencimiento, estado)
VALUES (1, '5678901234567890', 3000.00, 1200.00, '2024-03-01', '2025-03-01', 'activa');

-- Tarjeta de Crédito 4
INSERT INTO Tarjetas_Credito (cuenta_id, numero_tarjeta, limite_credito, saldo_actual, fecha_emision, fecha_vencimiento, estado)
VALUES (3, '2345678901234567', 8000.00, 3000.00, '2023-08-10', '2024-08-10', 'activa');
